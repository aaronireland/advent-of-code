<h1 align="center">DECEMBER 4, 2021</h1>
<p align="center">--- Day 4: Giant Squid ---</p>

**PART ONE**

<article class="day-desc"><p>You're already almost 1.5km (almost a mile) below the surface of the ocean, already so deep that you can't see any sunlight. What you <em>can</em> see, however, is a giant squid that has attached itself to the outside of your submarine.</p>
...
<p>Your puzzle answer was <code>2745</code>.</p>
...
<article class="day-desc"><p>On the other hand, it might be wise to try a different strategy: <span title="That's 'cuz a submarine don't pull things' antennas out of their sockets when they lose. Giant squid are known to do that.">let the giant squid win</span>.</p>
...
<p>Your puzzle answer was <code>6594</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>
